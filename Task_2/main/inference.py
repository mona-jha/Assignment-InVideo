...
def run_inference(args):
    """Run inference (zero-shot face generation)."""
    # Set device
...
def main():
    parser = argparse.ArgumentParser(description="Face Generation Inference (Zero-Shot)")
    parser.add_argument("--mode", type=str, required=True, choices=["inference"],
                        help="Mode to run (only 'inference' is supported)")
